...
const sections = [
  ...
  { href: "/admin/review", title: "每日评报管理", desc: "评报生成规则（字数/模块/数量）与展示规则（媒体名/标题/链接/依据）", icon: FileText },
  { href: "/admin/scheduler", title: "定时任务", desc: "线索识别 / 每周简报 / 每日评报的自动调度开关、cron 时间与运行日志", icon: Clock },
